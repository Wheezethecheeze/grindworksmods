...
static var all_releases: Array[ReleaseNote] = [
	load(RELEASES_PATH + "v1.2.5.tres"),
	load(RELEASES_PATH + "v1.2.4.tres"),
	load(RELEASES_PATH + "v1.2.3.tres"),
	load(RELEASES_PATH + "v1.2.2.tres"),
	load(RELEASES_PATH + "v1.2.1.tres"),
